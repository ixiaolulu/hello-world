...
public class RSAUtils1 {
     ...
     */
    public static byte[] rsaEncrypt(String encryptContent, String rsaPublicKey, String charset) throws GeneralSecurityException, UnsupportedEncodingException {
     ...
     */
    public static byte[] rsaDecrypt(String decryptContent, String rsaPrivateKey) throws GeneralSecurityException, IOException {
